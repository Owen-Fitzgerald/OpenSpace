...
namespace Geraldine._4XEngine.Initializers
{
    public class GalaxyInitializer
    {
        ...
        public enGalaxyAge Age { get; set; }

        public GalaxyInitializer(GalaxySize size, float hyperlaneDensity, float habitablePlanetDensity,
                            int numberOfNations, float minEmpireDistance, string precursorStory,
                            string crisisStory, enGalaxyAge age)
        {
            Size = size;
            HyperlaneDensity = hyperlaneDensity;
            HabitablePlanetDensity = habitablePlanetDensity;
            NumberOfNations = numberOfNations;
            MinEmpireDistance = minEmpireDistance;
            PrecursorStory = precursorStory;
            CrisisStory = crisisStory;
            Age = age;
        }
    }
}
